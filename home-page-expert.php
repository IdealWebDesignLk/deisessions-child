<?php /* Template Name: homepage_expert */ ?>
<?php get_header(); ?>
                            ...
                            <div class="col-12 col-md">
                                <div class="text-wrapper">
                                    ...
                                    <h3 class="headeremployeename">
                                        ...
                                        <?php if (get_field('disable', $worduser)) : ?>
                                    ...
                                    <div class="price">
                                        <h3 class="session-price">60 minutes / <?php echo $service[0]->price; ?> $</h3>
                                    </div>
                                    <div class="views">
            ...
            ?>
                <div class="searchresult">
                    ...
                    if ($budget != "" || $budgetx != "") {
                        ...
                        if ($query != "") {
                            $query .= " or price BETWEEN '$budget' AND '$budgetx' ";
                        } else {
                    ...
                    ?>
                        <form method="POST" class="filterform">
                            <div class="row filter">
                                <input type="text" name="topicid" value="<?php echo $topic ?>">
                                <input type="text" name="fsearchtxt" value="<?php echo $searchtext ?>">
                                <input type="text" name="fcatname" value="<?php echo $topicz ?>">
                                <input type="text" name="fbudgetmin" value="<?php echo $budget ?>">
                                <input type="text" name="fbudgetmax" value="<?php echo $budgetx ?>">
                                ...
                                <div class="col colsm6">
                                    <div class="form-group">
                                        <input type="text" placeholder="Time from" class="form-control" id="Timefrom" name="Timefrom">
                                    </div>
                                </div>
                                <div class="col colsm6">
                                    <div class="form-group">
                                        <input type="text" placeholder="Timeto" class="form-control" id="Timeto" name="Timeto">
                                    </div>
                                </div>
                                <div class="col colsm6">
                                    <div class="form-group">
                ...
                ?>
                    <div class="searchresult">
                        <form method="POST" class="filterform">
                            <div class="row filter">
                                <input type="text" name="topicid" value="<?php echo $ftopic ?>">
                                <input type="text" name="fsearchtxt" value="<?php echo $searchtext ?>">
                                <input type="text" name="fcatname" value="<?php echo $topicz ?>">
                                <input type="text" name="fbudgetmin" value="<?php echo $budget ?>">
                                <input type="text" name="fbudgetmax" value="<?php echo $budgetx ?>">
                        ...
                        // echo $_POST["Date"];
                        $finladate = "'" . $arrdate[2] . "-" . $arrdate[1] . "-" . $arrdate[0] . "'";
                        // echo $finladate;
                        $date = strtotime($finladate);
                        // echo date('l', $date);
                        ...
                        <?php
                            ...
                            echo "<div class='nores'> <h3>No result found using filter </h3></div>";
                        }
                        ?>
                    </div>
                <?php
