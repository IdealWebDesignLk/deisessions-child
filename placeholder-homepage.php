...
<div id="primary" class="content-area  placeholderpage">
			...
			<div class="bg-video-wrap">
				<div class="video-background">
					<div class="video-foreground">
						...
						<iframe id="youtube-video" class="youtube-video" width="278" height="154" src="https://www.youtube.com/embed/BoEC7qMvTFE?enablejsapi=1&rel=0&start=9&mute=1&autoplay=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>


						<?php
						$videourlhero = "https://www.youtube.com/embed/BoEC7qMvTFE";
...
<div class="grey-placeholder">
	<div class="grey-placeholder-inner">
		<h2>
			We are building the expert speaker platform of the future. 
Bear with us. We’re almost ready to launch...
			<!-- Leave your e-mail address and we’ll notify you when we go live. -->
		</h2>
	<!--<?php echo do_shortcode('[quform id="2" name="Placeholder email"]'); ?>	 -->
	</div>
</div>
