                            ...
                            ?>
                                    ...
                                    ?>
                                        ...
                                        ?>
                                            ...
                                            <div class="item mainitem kd-service-slide" data-tags="<?php echo $tagone . $tagtwo . $tagthree . $tagfour . $tagfive; ?>" data-description="<?php echo do_shortcode($row->description); ?>" data-expert = "<?php echo $employeedetails->firstName . " " . $employeedetails->lastName;  ?>" data-category="<?php echo $catResult->name; ?>" data-price="<?php echo $row->price; ?>" data-name="<?php echo $row->name; ?>">
